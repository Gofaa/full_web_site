...
from .views import news_list, news_detail, IndexView, ContactPageView, NoteFoundPage, LocalNewsView, TechnologyNewsView, ForeignNewsView, SportNewsView, NewsUpdateView, NewsDeleteView, NewsCreateView
urlpatterns = [
